...
export const ELEMENT_DESCRIPTIONS = {
  Wood: {
    comments: [
      "콘크리트를 뚫고 나오는 새싹처럼, 무서울 정도의 추진력과 생동감이 기운차게 돋아나네.",
      "좌우를 살피기보다 오직 위로만 곧게 뻗어 가려는 그 강직함이 아주 귀하게 다가와."
    ]
  },
  Fire: {
    comments: [
      "주변의 온도를 단번에 화사하게 상승시키는 따뜻하고 적극적인 힘을 발휘하네.",
      "어떻게든 주변을 밝게 비추려는 그 결연함과 헌신적인 태도가 눈에 띄네.",
      "비밀없이 솔직하고 투명한 그 기운이 사람들을 자석처럼 끌어당기는 묘한 매력을 발산해."
    ]
  },
  Earth: {
    comments: [
      "폭풍 속에서도 흔들리지 않는 한결같음, 그 묵직한 안정감이 주변 동료들을 절로 안심되게 만드네.",
      "무엇이든 품어 안고 묵묵하게 견디는 넓은 수용력이 너의 가장 강력한 비책이자 무기야."
    ]
  },
  Metal: {
    comments: [
      "잘 벼려진 은빛 칼날처럼 서늘하고 명징한 기운이 네 말에 단단한 무게를 실어 주네.",
      "불필요한 인연과 군말을 단칼에 쳐내는 그 매서운 결단에서 고독과 고결함이 동시에 뿜어져 나와."
    ]
  },
  Water: {
    comments: [
      "얼마나 깊은 생각과 무궁한 지혜가 가슴속 깊은 계곡에서 소용돌이치고 있을지 절로 궁금해지네.",
      "어떤 그릇이든 자유자재로 채우는 유연함과 탁월한 생존력이 정말 무서울 정도로 뛰어나.",
      "지평선 너머 바다처럼 차분하며 웅장한 기운으로 은연중에 전체를 압도해 버리는 매력이 있네."
    ]
  }
};
