...
export const ELEMENT_DESCRIPTIONS = {
  Wood: {
    comments: [
      "콘크리트를 뚫고 나오는 새싹처럼, 무서울 정도의 추진력과 생동감이 아주 선명하게 전해져 와.",
      "좌우를 살피기보다 오직 위로만 곧게 뻗어 가려는 강직함이 정말 독보적인 매력이야."
    ]
  },
  Fire: {
    comments: [
      "주변의 온도를 단번에 화사하게 끌어올리는 따뜻하고 적극적인 에너지가 가득하네.",
      "어떻게든 주변을 밝게 비추려고 노력하는 그 결연함과 헌신적인 태도가 유독 돋보여.",
      "비밀 없이 솔직하고 투명한 기운이 사람들을 자석처럼 끌어당기는 근사한 매력이 있어."
    ]
  },
  Earth: {
    comments: [
      "폭풍 속에서도 흔들리지 않는 한결같음, 그 묵직한 안정감이 주변 사람들을 절로 안심시키곤 해.",
      "무엇이든 품어 안고 묵묵하게 견뎌내는 넓은 수용력이야말로 너의 가장 강력한 무기이자 저력이야."
    ]
  },
  Metal: {
    comments: [
      "잘 벼려진 은빛 칼날처럼 서늘하고 명징한 기운이 네 말 한마디 한마디에 단단한 무게를 더해주네.",
      "불필요한 인연과 잡념을 단칼에 쳐내는 매서운 결단에서 고독하면서도 고결한 기운이 뿜어져 나와."
    ]
  },
  Water: {
    comments: [
      "얼마나 깊은 생각과 무궁한 지혜가 가슴속 깊은 곳에서 소용돌이치고 있을지 문득 궁금해질 정도야.",
      "어떤 그릇이든 자유자재로 채우는 유연함과 탁월한 생존력이 정말 놀라울 정도로 뛰어나네.",
      "지평선 너머 바다처럼 차분하면서도 웅장한 아우라로 은연중에 전체를 압도해 버리는 힘이 있어."
    ]
  }
};
