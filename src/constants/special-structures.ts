...
export const SPECIAL_STRUCTURE_DEFINITIONS: Record<string, SpecialStructureInfo> = {
  ...
  "가색격": {
    ...
    category: "Monarch",
    description: "토(土)의 기운이 두텁게 쌓인 격국으로, 신용과 풍요, 포용력을 상징합니다.",
    enDescription: "A structure with thick Earth energy, symbolizing trust, abundance, and tolerance.",
    marketingMessage: "모든 것을 품어 결실을 맺게 하는 대지와 같은 포용력의 소유자입니다.",
  ...
  "윤하격": {
    ...
    category: "Monarch",
    description: "수(水)의 기운이 깊게 흐르는 격국으로, 지혜와 유연성, 침투력을 상징합니다.",
    enDescription: "A structure where Water energy flows deeply, symbolizing wisdom, flexibility, and penetration.",
    marketingMessage: "어떤 장애물도 유연하게 넘어서는 깊은 지혜와 통찰력의 소유자입니다.",
  ...
  "종아격": {
    ...
    category: "Adaptive",
    description: "자신의 기운을 쏟아내는 식상(Artist/Rebel)의 기운에 순응하는 격국입니다.",
    enDescription: "A structure that adapts to the energy of Sik-sang (Artist/Rebel), which pours out one's own energy.",
    marketingMessage: "환경에 적응하는 천재성: 시대의 흐름을 읽고 자신의 재능을 무한히 확장합니다.",
  ...
  "종재격": {
    ...
    category: "Adaptive",
    description: "세상의 결과물인 재성(Maverick/Architect)의 흐름에 몸을 맡기는 격국입니다.",
  ...
  "종살격": {
    ...
    category: "Adaptive",
    description: "강력한 조직이나 규칙인 관성(Warrior/Judge)의 권위에 순응하는 격국입니다.",
    ...
    marketingMessage: "환경에 적응하는 천재성: 거대한 조직의 흐름을 타고 최고의 권위에 도달합니다.",
  ...
  "종왕격": {
    ...
    category: "Adaptive",
    description: "나와 같은 기운인 비겁(Mirror/Rival)의 강력한 세력에 합류하는 격국입니다.",
    enDescription: "A structure that joins the powerful force of Bi-geop (Mirror/Rival), which is the same energy as oneself.",
    marketingMessage: "환경에 적응하는 천재성: 강력한 네트워크와 동료애를 바탕으로 독보적인 세력을 구축합니다.",
