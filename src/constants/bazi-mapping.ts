...
export const BAZI_MAPPING = {
  ...
  shenSha: {
    ...
    "귀문관살": { ko: "귀문관살(鬼門關殺)", en: "Ghost Gate", desc: "Intense focus and genius inspiration. Strong obsession and creative drive.", descKo: "집요함과 천재적 영감, 고도의 집중력을 상징하며 예술가나 전문가에게 유리합니다." },
    "현침살": { ko: "현침살(懸針殺)", en: "Dangling Needle", desc: "Sharp insight and specialized skills. Talent for precision and criticism.", descKo: "날카로운 통찰력과 전문 기술을 상징하며, 의료, 비평, 기술 분야에 재능이 있습니다." },
    "탕화살": { ko: "탕화살(湯火殺)", en: "Scalding Fire", desc: "Sudden emotional shifts and passion. Ability to handle intense change.", descKo: "욱하는 기질과 열정적인 변화를 상징하며, 감정의 기복을 다스리는 힘이 필요합니다." },
    "고란살": { ko: "고란살(孤鸞殺)", en: "Solitary Phoenix", desc: "Independence and self-reliance. Strong power to succeed on one's own.", descKo: "독립심이 강하고 자수성가할 힘을 상징하며, 주체적인 삶을 개척하는 기운입니다." },
    "고신살": { ko: "고신살(孤神殺)", en: "Solitary God", desc: "Self-reflection and inner exploration. Finding strength in solitude.", descKo: "자발적 고독과 내면의 탐구를 상징하며, 정신적인 성숙과 깊이를 더하는 기운입니다." },
    "과숙살": { ko: "과숙살(寡宿殺)", en: "Widow Star", desc: "Self-directed life and independence. Strong inner strength.", descKo: "자기 주도적 삶과 독립성을 상징하며, 혼자서도 꿋꿋하게 일어설 수 있는 힘입니다." },
    "원진살": { ko: "원진살(元嗔殺)", en: "Resentment Star", desc: "Complex relationships and deep sensitivity. Emotional depth.", descKo: "복잡한 인간관계와 깊은 감수성을 상징하며, 타인의 마음을 읽는 섬세함이 있습니다." },
    "천덕귀인": { ko: "천덕귀인(天德貴人)", en: "Heavenly Virtue", desc: "Heavenly protection. Turns misfortune into fortune and brings help.", descKo: "하늘의 보살핌으로 흉이 길로 변하며, 예상치 못한 도움을 받는 길성입니다." },
    "월덕귀인": { ko: "월덕귀인(月德貴人)", en: "Monthly Virtue", desc: "Smooth progress and social support. Brings harmony and success.", descKo: "매사 순조롭고 인덕이 두터우며, 사회적인 성취와 조화를 돕는 기운입니다." },
    "태극귀인": { ko: "태극귀인(太極貴人)", en: "Great Polarity", desc: "Good start and end. Brings great prosperity and longevity.", descKo: "시작과 끝이 좋고 큰 복록을 누리며, 인생의 전반적인 안정을 돕는 길성입니다." },
    "암록": { ko: "암록(暗祿)", en: "Hidden Prosperity", desc: "Hidden help and unexpected fortune. Secret support from others.", descKo: "보이지 않는 도움과 예상치 못한 횡재를 상징하며, 위기 상황에서 귀인을 만납니다." },
  },
  strength: {
