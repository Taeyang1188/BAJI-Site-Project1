...
export const BAZI_MAPPING = {
  ...
  stems: {
    "甲": { ko: "갑목", en: "Gap (Yang Wood)", element: "Wood" },
    "乙": { ko: "을목", en: "Eul (Yin Wood)", element: "Wood" },
    "丙": { ko: "병화", en: "Byeong (Yang Fire)", element: "Fire" },
    "丁": { ko: "정화", en: "Jeong (Yin Fire)", element: "Fire" },
    "戊": { ko: "무토", en: "Mu (Yang Earth)", element: "Earth" },
    "己": { ko: "기토", en: "Gi (Yin Earth)", element: "Earth" },
    "庚": { ko: "경금", en: "Gyeong (Yang Metal)", element: "Metal" },
    "辛": { ko: "신금", en: "Sin (Yin Metal)", element: "Metal" },
    "壬": { ko: "임수", en: "Im (Yang Water)", element: "Water" },
    "癸": { ko: "계수", en: "Gye (Yin Water)", element: "Water" },
  },
  branches: {
    "子": { ko: "자수", en: "Ja (Rat)", element: "Water", hiddenStems: ["壬", "癸"] },
    "丑": { ko: "축토", en: "Chuk (Ox)", element: "Earth", hiddenStems: ["癸", "辛", "己"] },
    "寅": { ko: "인목", en: "In (Tiger)", element: "Wood", hiddenStems: ["戊", "丙", "甲"] },
    "卯": { ko: "묘목", en: "Myo (Rabbit)", element: "Wood", hiddenStems: ["甲", "乙"] },
    "辰": { ko: "진토", en: "Jin (Dragon)", element: "Earth", hiddenStems: ["乙", "癸", "戊"] },
    "巳": { ko: "사화", en: "Sa (Snake)", element: "Fire", hiddenStems: ["戊", "庚", "丙"] },
    "午": { ko: "오화", en: "O (Horse)", element: "Fire", hiddenStems: ["丙", "己", "丁"] },
    "未": { ko: "미토", en: "Mi (Goat)", element: "Earth", hiddenStems: ["丁", "乙", "己"] },
    "申": { ko: "신금", en: "Sin (Monkey)", element: "Metal", hiddenStems: ["戊", "壬", "庚"] },
    "酉": { ko: "유금", en: "Yu (Rooster)", element: "Metal", hiddenStems: ["庚", "辛"] },
    "戌": { ko: "술토", en: "Sul (Dog)", element: "Earth", hiddenStems: ["辛", "丁", "戊"] },
    "亥": { ko: "해수", en: "Hae (Pig)", element: "Water", hiddenStems: ["戊", "甲", "壬"] },
  },
  lifeStages: {
