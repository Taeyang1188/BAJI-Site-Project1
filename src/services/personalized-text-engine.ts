...
export function generatePersonalizedTexts(
  ...
  if (hasExplosiveTrigger) {
    ...
    defaultPsychology = isKO
      ...
      : "You possess a Bazi chart with a **Wealth Tomb (財庫)** or branch configurations that act as a heavy, secure vault for your assets. **When treating money**, you do not waste minor cash; instead, you have the **boldness to wait patiently for a major opportunity**. **When earning money**, your core strategy is to **quietly preserve your asset size** while highly compressing your seed money. Then, during key luck cycles (clash or union periods) that **unlock this vault, you must capture massive wealth in a single grand leap.** Rather than exhausting your energy chasing trivial profits, it is vital to **design a large-scale asset flow** in advance. **Things to watch out for** include getting swayed by small temptations, short-term trading, or light investment tips from others, which can lead to **wasting your hard-earned seed money**. To fully secure this explosive wealth, you should lock your capital in illiquid forms like real estate or long-term bonds to prevent yourself from easily withdrawing it.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You possess a flow where your innate talent and execution (**Expression**) smoothly transform into immediate wealth (**Wealth**). **When treating money**, rather than receiving a fixed salary working under someone else, you feel the greatest thrill when creating high value-add through your own ideas and actions. **When earning money**, your core strategy is to package your ideas, content, or specialized skills into reproducible products (online courses, software solutions, intellectual property) to **decouple your time from your income**. You must expand your business into a **system that automatically replicates your brand**, moving away from directly selling your hours. **Things to watch out for** include getting stuck in personal satisfaction or art, thereby missing actual market demands. When you sharply analyze the exact points where the **market is willing to open its wallet** and productize them, your perpetual pipeline of wealth will be complete.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You possess a structure where you generate wealth (**Wealth**) and securely protect it through a robust system or credit network (**Officer**). **When treating money**, you value stable and perpetual flows over temporary windfalls. **When earning money**, rather than relying on direct physical labor, you compound your assets most powerfully by leveraging the **'shadow of systems'**—such as franchises, corporate entities, large platforms, or government partnerships. The ultimate strategy is to write systematic manuals and regulations to **design a structure that runs without you**. **Things to watch out for** include damage to your personal credit score or corporate brand reputation. The moment you lose credibility, your wealth flow destabilizes. Therefore, you must prioritize **honest and public execution of promises** and continuously build regular cash cows like royalties or fixed rents.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You possess a flow where solid information and intellectual qualifications (**Resource**) are converted into tangible assets (**Wealth**). **When treating money**, you value knowledge and technical capability over physical labor or active sales, putting high weight on intangible credentials and rights. **When earning money**, instead of running active sales, you maximize efficiency by freezing your expertise and academic values into legal documents (**trademark registration, patents, copyrights, books**) to receive royalties. You must move to a **higher position that licenses credentials** or teaches your knowledge rather than getting stuck in short-term execution. **Things to watch out for** include neglecting or failing to protect your intangible assets. You must establish **legal safety devices** for all your works and constantly validate your authority through networks of experts.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You are born with a 'Peer Rivalry for Wealth' flow, where colleagues or competitors (**Companion**) with equal power compete fiercely for your wealth (**Wealth**). **When treating money**, your warm-hearted nature makes you prone to spending on or easily lending to people, making you vulnerable to peer influence. **When earning money**, you must unleash unique skills in competition to secure your share cleanly. Furthermore, the fastest way to compound your wealth is to **completely hide your earnings from sight**. If cash lies around in standard bank accounts, it will inevitably flow out. Thus, as soon as you earn money, you must transfer it to **restrictive accounts that block easy withdrawal** (real estate, pensions, savings programs). **Things to watch out for** include joint venture proposals, investment pitches, or loan requests. You must block these three completely and keep your **exact asset size an absolute secret** to protect your wealth.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You have a Bazi structure with little to no direct wealth stars (**Wealth**). The more you chase money calculating numbers, the more your projects tangle and decisions cloud. **When treating money**, you value your pure passion, interest, and the value of creation (**Expression**) over money itself. **When earning money**, paradoxically, you must let go of 'thinking about profits' and fully immerse yourself in **your deep expertise and unique talents** to build an unmatched artisan territory. The key is to possess an **artisan spirit**, digging one well persistently until your special skill gains market recognition. **Things to watch out for** include losing practical gains because you dislike billing or settlements. Never hesitate to ask for fair compensation; either **pre-announce a transparent pricing rate chart**, or outsource money management completely to a trusted partner or system.";
    actionPlans = isKO ? [
    ...
    defaultPsychology = isKO
      ...
      : "You possess a self-made flow where active willpower (**Companion**), execution power (**Expression**), and honest rewards (**Wealth**) weave tightly together to build wealth from scratch. **When treating money**, you refuse to rely on or beg others, trusting only the assets carved out by your own sweat. **When earning money**, rather than lining up under large corporate umbrellas or seeking handouts, you succeed by honing your solid technical skills and practical execution to **raise your personal market value**. Packaging your skills into digital items (e-books, online courses) and establishing **your own distribution routes** is the key to multiplying your assets. **Things to watch out for** include exhausting your body by micromanaging all operations. Once you scale past a one-person business, you must gradually **outsource tasks and collaborate**, prioritizing a fixed amount of time and energy to **preserve your own health routine** to enjoy your wealth.";
    actionPlans = isKO ? [
