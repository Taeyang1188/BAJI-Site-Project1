...
export function generateSoulSummary(result: BaZiResult, lang: Language): SoulSummary {
  ...
  const coreEnergyMap: Record<string, any> = {
    "인성": {
      ko: {
        description: isStrongDM 
          ? `내면의 단단한 주관을 지혜롭게 뒷받침할 수 있도록, 객관적인 지식이나 학문적 탐구, 차분한 자아 성찰을 일상에 채우는 방법이 가장 조화롭습니다.`
          : `학술 연구나 라이선스 등 전문 분야에 몰입하며, 나의 내외면을 든든하게 받쳐줄 가치 있는 배움을 차근차근 내 안의 기둥으로 세우는 주체적 축적의 방식이 좋습니다.`,
    ...
    "비겁": {
      ko: {
        description: !isStrongDM
          ? `타인의 간섭이나 외부의 불필요한 요구에 휘둘리지 않고, 스스로 세운 주권적 가치관과 주도적인 최종 결정권을 굳건히 지켜가며 나만의 중심을 잡는 태도가 필요합니다.`
          : `모든 일을 나 홀로 감당하느라 지치는 행동을 경계하고, 뜻이 맞고 끈끈한 철학을 공유하는 신뢰 어린 동료들과 함께 지탱하며 동행할 때 한 걸음 더 도약하게 됩니다.`,
        practicalAdvice: !isStrongDM
    ...
    "식상": {
      ko: {
        description: isStrongDM
          ? `머릿속으로 가득 구상하느라 축적된 독창적 아이디어와 정교한 설계를 망설임 없이 세상 밖으로 드러내어 실제적인 행동과 창조 활동으로 구현하는 실천이 잘 맞습니다.`
          : `세상이 부여한 과도한 도덕적 기준이나 타인의 평가 지표에서 가벼운 모습으로 벗어나, 나의 순수한 호기심을 해소해 줄 새로운 취미에 신나게 몰입해 보는 것이 현명합니다.`,
        practicalAdvice: isStrongDM
    ...
    "재성": {
      ko: {
        description: isStrongDM
          ? `뜬구름 잡는 공상에서 벗어나 눈앞에 펼쳐진 현실의 명확한 흐름과 유한한 물리적 자원들을 질서 정연하고 실체 있게 가꾸고 적극 조율해 나가는 습관이 가장 이상적입니다.`
          : `막막한 주변 소문이나 불확실한 도전에 동요하기보다는, 내가 확실하게 다스리고 긴밀하게 소유관할 수 있는 물리적인 일상 공간부터 확실히 정리해 가는 적극적인 정돈이 도움이 됩니다.`,
        practicalAdvice: isStrongDM
    ...
    "관성": {
      ko: {
        description: isStrongDM
          ? `나의 탄탄한 전문 자질과 사회가 요구하는 합리적인 규범을 매끄럽게 연결하고, 기꺼이 책임을 다하며 공인된 신뢰와 정돈된 구조적 질서를 다져 나가는 자립적 경영이 훌륭하게 작동합니다.`
          : `남들이 강요하는 눈치와 무거운 책임감의 십자가를 그대로 받아들고 끙끙 앓기보다, 오직 나만을 완벽하게 충전하고 회복시킬 안전하고 든든한 일상의 방어벽을 선명하게 다질 때 힘이 생깁니다.`,
        practicalAdvice: isStrongDM
